                ...
                <div class="swiper-container main-slider" id="myCarousel">
                	<%
                		...
                		if (circuito != null){
		            		...
		            		if (multimediaEjb.getMultimediaCircuitoById(circuito.getID()) == null){
			            		out.print("		<tr><td><h3>Multimedia: </h3></td><td><h3><a href='SubirImagenCircuito?id="+circuito.getID()+"'><button class='btn btn-secondary btn-xs' style='width: 100%'><i class='fas fa-edit'></i></button></a></td></tr>");
		            		}		            		
