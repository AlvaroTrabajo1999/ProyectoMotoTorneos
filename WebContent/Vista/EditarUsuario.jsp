...
<html>
    ...
    <body id="page-top">
		...
		<%
			//tomamos el piloto que se desea editar y su multimedia
                        	...
                        	<div class="row row-space">
                        		<div class="col">
                                    <div class="input-group">
                                        ...
                                        <input class="input--style-4" type="text" name="nombre" value="<%out.print(usu.getNombre());%>" required>
                                        <input type="hidden" name="id" value="<%out.print(usu.getID());%>">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="input-group">
                                        <label class="label">Apellido</label>
                                        <input class="input--style-4" type="text" name="apellido" value="<%out.print(usu.getApellidos());%>" required>
                                        <input type="hidden" name="contrasena" value="<%out.print(usu.getContrasena());%>">
                                    </div>
                                </div>
                        	</div>
                        	<div class="row row-space">
                                <div class="col">
                                    <div class="input-group">
                                        ...
                                        <input class="input--style-4" type="text" name="mail" min="0" value="<%out.print(usu.getMail());%>" required>
                                    </div>
                                </div>
                           	</div>
                        	<div class="row row-space">
