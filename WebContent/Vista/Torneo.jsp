	                    ...
	                    <%
							...
							if (torneos != null){
								for (Torneo t : torneos){
									...
									out.print("		<td>"+baseEjb.getCircuitoFromId(t.getId_circuito()).getLocalidad()+"</td>");
									out.print("		<td><a href='FichaTorneo?id="+t.getID()+"'><button class='btn btn-primary btn-xs'><i class='fas fa-edit'></i></button></a></td>");
