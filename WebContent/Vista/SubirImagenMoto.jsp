...
<html>
    ...
    <body id="page-top">
		...
		<%
			String moto = (String) request.getAttribute("motocicleta");
			sesion.setAttribute("moto", moto);
		%>
         ...
         <div class="page-wrapper p-t-130 p-b-100 font-poppins">
            <div class="wrapper wrapper--w680">
                <div class="card card-4">
                    <div class="card-body">
                        <h2 class="title">Multimedia Motocicleta</h2>
                        <form method="POST" action="SubirImagenMoto" enctype="multipart/form-data">
