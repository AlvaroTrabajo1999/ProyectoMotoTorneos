        ...
        <div class="page-wrapper p-t-130 font-poppins">
            <div class="wrapper wrapper--w680">
                <div class="card card-4">
                    <div class="card-body">
                        <h2 class="title">Añadir Piloto Nuevo</h2>
                        <form method="POST" action="AnadirPiloto">
                            <div class="row row-space">
                                <div class="col">
                                    <div class="input-group">
                                        <label class="label">DNI</label>
                                        <input class="input--style-4" type="text" name="dni" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row row-space">
                            ...
                            <div class="row row-space">
                                <div class="col">
                                    <div class="input-group">
                                        ...
                                        <input class="input--style-4" type="number" name="peso" step="any" min="0" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row row-space">
                                <div class="col">
                                    <div class="input-group">
                                        ...
                                        <input class="input--style-4" type="number" name="altura" min="0" step="any" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="input-group">
                                        <label class="label">Edad</label>
                                        <input class="input--style-4" type="number" name="edad" min="0" required>
                                    </div>
                                </div>
                            </div>
                            <div class="p-t-15">
