...
<html>
    ...
    <body id="page-top">
		...
		<%
			String piloto = (String) request.getAttribute("piloto");
			sesion.setAttribute("piloto", piloto);
		%>
         ...
         <div class="page-wrapper p-t-130 p-b-100 font-poppins">
            <div class="wrapper wrapper--w680">
                <div class="card card-4">
                    <div class="card-body">
                        <h2 class="title">Multimedia Piloto</h2>
                        <form method="POST" action="SubirImagenPiloto" enctype="multipart/form-data">
